...
class getSliceInfo(QtGui.QDialog):
	def __init__(self, parent=None):

		super(getSliceInfo, self).__init__(parent)
		...
		self.buttons=QtGui.QDialogButtonBox(QtGui.QDialogButtonBox.ActionRole | QtGui.QDialogButtonBox.Ok | 
	...
	def getSlice(parent=None): #called from mainWindow module (for collecting user input region slice parameters)
		dialog=getSliceInfo(parent)
		result=dialog.exec_()
		
		lowerbound = max( 1, float( dialog.lowerbound.text() ) ) 
